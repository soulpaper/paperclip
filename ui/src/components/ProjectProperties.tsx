  ...
  return (
    <div className="space-y-3 rounded-md border border-destructive/40 bg-destructive/5 px-4 py-4">
      <p className="text-sm text-muted-foreground">
        {isArchive
          ? t("projectProperties.archiveDesc")
          : t("projectProperties.unarchiveDesc")}
      </p>
      {archivePending ? (
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-destructive font-medium">
            {isArchive ? t("projectProperties.archiveConfirm", { name: project.name }) : t("projectProperties.unarchiveConfirm", { name: project.name })}
          </span>
          <Button
            size="sm"
            variant="destructive"
...
export function ProjectProperties({ project, onUpdate, onFieldUpdate, getFieldSaveState, onArchive, archivePending }: ProjectPropertiesProps) {
  ...
  const submitLocalWorkspace = () => {
    ...
    if (!isAbsolutePath(cwd)) {
      setWorkspaceError(t("projectProperties.localFolderAbsolutePathError"));
      return;
    }
    setWorkspaceError(null);
    persistCodebase({ cwd });
  ...
  const submitRepoWorkspace = () => {
    ...
    if (!isGitHubRepoUrl(repoUrl)) {
      setWorkspaceError(t("projectProperties.repoInvalidUrlError"));
      return;
    }
    setWorkspaceError(null);
  ...
  return (
    <div>
      <div className="space-y-1 pb-4">
        ...
        <PropertyRow label={<FieldLabel label={t("common.status")} state={fieldState("status")} />}>
          {onUpdate || onFieldUpdate ? (
            <ProjectStatusPicker
        ...
        {project.targetDate && (
          <PropertyRow label={<FieldLabel label={t("common.targetDate")} state="idle" />}>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  {onUpdate || onFieldUpdate ? (
                    ...
                    <span className="text-xs text-muted-foreground">
                      {executionWorkspacesEnabled ? t("common.on") : t("common.off")}
                    </span>
                  )}
                </div>
                ...
                {executionWorkspacesEnabled ? (
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-border/60 pt-2">
                      ...
                      >
                        {executionWorkspaceAdvancedOpen
                          ? t("projectProperties.hideAdvancedSettings")
                          : t("projectProperties.showAdvancedSettings")}
                      </button>
                    </div>
                    ...
                    {executionWorkspaceAdvancedOpen ? (
                      <div className="space-y-3">
                        <div className="text-xs text-muted-foreground">
                          {t("projectProperties.hostManagedImpl")}: <span className="text-foreground">{t("common.worktree")}</span>
                        </div>
                        <div>
                        ...
                        <p className="text-[11px] text-muted-foreground">
                          {t("projectProperties.provisionTeardownNote")}
                        </p>
                      </div>
                    ) : null}
                  </div>
