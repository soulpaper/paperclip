...
const platformDefs: { id: Platform; labelKey: string; icon: typeof Apple }[] = [
...
export function PathInstructionsModal({
  ...
  const stepsKey = `pathInstructions.${platform}Steps` as const;
  const tipKey = `pathInstructions.${platform}Tip` as const;
