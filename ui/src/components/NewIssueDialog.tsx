...
const ISSUE_THINKING_EFFORT_OPTIONS = {
  claude_local: [
    { value: "", labelKey: "newIssueDialog.effortDefault" },
    { value: "low", labelKey: "newIssueDialog.effortLow" },
    { value: "medium", labelKey: "newIssueDialog.effortMedium" },
    { value: "high", labelKey: "newIssueDialog.effortHigh" },
  ],
  codex_local: [
    { value: "", labelKey: "newIssueDialog.effortDefault" },
    { value: "minimal", labelKey: "newIssueDialog.effortMinimal" },
    { value: "low", labelKey: "newIssueDialog.effortLow" },
    { value: "medium", labelKey: "newIssueDialog.effortMedium" },
    { value: "high", labelKey: "newIssueDialog.effortHigh" },
  ],
  opencode_local: [
    ...
    { value: "medium", labelKey: "newIssueDialog.effortMedium" },
    { value: "high", labelKey: "newIssueDialog.effortHigh" },
    { value: "max", labelKey: "newIssueDialog.effortMax" },
  ],
} as const;
...
const EXECUTION_WORKSPACE_MODES = [
  { value: "shared_workspace", labelKey: "newIssueDialog.projectDefault" },
  { value: "isolated_workspace", labelKey: "newIssueDialog.newIsolatedWorkspace" },
  { value: "reuse_existing", labelKey: "newIssueDialog.reuseExistingWorkspace" },
] as const;
  ...
  const createIssue = useMutation({
    ...
    onSuccess: ({ issue, companyId, failures }) => {
      ...
      if (failures.length > 0) {
        ...
        pushToast({
          title: t('newIssueDialog.createdWithWarnings', { ref: issueRef }),
          body: t('newIssueDialog.uploadWarningsBody', { count: failures.length }),
          tone: "warn",
          action: prefix
            ? { label: t('newIssueDialog.openIssue', { ref: issueRef }), href: `/${prefix}/issues/${issueRef}` }
            : undefined,
        });
      }
      clearDraft();
