            ...
            <div className="border-t border-r border-border px-3 py-2 bg-background">
              <div className="flex items-center gap-1">
                ...
                <Button
                  ...
                  onClick={toggleTheme}
                  aria-label={nextTheme === 'light' ? t('common.switchToLight') : t('common.switchToDark')}
                  title={nextTheme === 'light' ? t('common.switchToLight') : t('common.switchToDark')}
                >
                ...
                <Button
                  ...
                  aria-label={i18n.language === "ko" ? "English" : "한국어"}
