...
export function PluginSettings() {
  ...
  if (pluginLoading) {
    return <div className="p-4 text-sm text-muted-foreground">{t("pluginSettings.loadingDetails")}</div>;
  }
                    ...
                    <>
                      <div>
                        ...
                        {dashboardData.worker ? (
                              ...
                              <>
                                <div className="flex justify-between col-span-2">
                                  ...
                                  <span className="text-xs">
                                    {t("pluginSettings.workerCrashesSummary", {
                          ...
                          <p className="text-sm text-muted-foreground italic">{t("pluginSettings.noWorkerProcess")}</p>
                        )}
                      </div>
                      ...
                      <div className="flex items-center gap-1.5 border-t border-border/50 pt-2 text-xs text-muted-foreground">
                        ...
                        {t("pluginSettings.lastChecked")} {new Date(dashboardData.checkedAt).toLocaleTimeString()}
                      </div>
                    </>
                  ) : (
                    <p className="text-sm text-muted-foreground">
                ...
                <CardContent>
                  {healthLoading ? (
                    ...
                    <div className="space-y-3 text-sm text-muted-foreground">
                      ...
                      <p>{t("pluginSettings.healthChecksNote")}</p>
                      {plugin.lastError ? (
                        <div className="break-words rounded border border-destructive/20 bg-destructive/10 p-2 text-xs text-destructive">
                          {plugin.lastError}
                        </div>
